...
void PrintFunctionTests::registerAllTests(TestFramework &framework) {
	...
	framework.addTest("Print - Print and println combined",
	                  testPrintAndPrintln);
	...
	framework.addTest("Print - Multiple println statements",
	                  testMultiplePrintlnStatements);
	framework.addTest("Print - println in if statement",
	                  testPrintlnInIfStatement);
	framework.addTest("Print - println in else statement",
	                  testPrintlnInElseStatement);
