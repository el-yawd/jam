...
class CompilerTests {
  public:
	static void registerAllTests(TestFramework &framework) {
		...
		framework.addTest("Parser - Function Parameters",
		                  testParserFunctionParams);
