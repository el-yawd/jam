...
class IntegrationTests {
  public:
	static void registerTests(TestFramework &framework) {
		framework.addTest("Integration - Simple u8 Function",
		                  testSimpleU8Function);
		framework.addTest("Integration - u16 Function", testU16Function);
		framework.addTest("Integration - u32 Function", testU32Function);
		framework.addTest("Integration - Simple i8 Function",
		                  testSimpleI8Function);
		...
		framework.addTest("Integration - Mixed Signed Types",
		                  testMixedSignedTypes);
		framework.addTest("Integration - Complex Function",
		                  testComplexFunction);
		framework.addTest("Integration - Multiple Functions",
		                  testMultipleFunctions);
		framework.addTest("Integration - Boundary Values", testBoundaryValues);
		framework.addTest("Integration - Signed Boundary Values",
		                  testSignedBoundaryValues);
	}
