...
class TypeSystemTests {
  public:
	static void registerTests(TestFramework &framework) {
		...
		framework.addTest("Type System - getTypeFromString u16",
		                  testGetTypeU16);
		framework.addTest("Type System - getTypeFromString u32",
		                  testGetTypeU32);
		framework.addTest("Type System - getTypeFromString i8", testGetTypeI8);
		framework.addTest("Type System - getTypeFromString i16",
		                  testGetTypeI16);
		framework.addTest("Type System - getTypeFromString i32",
		                  testGetTypeI32);
  ...
  private:
	...
	static void testNumberASTI16() {
		...
		ASSERT_TRUE(valueNeg != nullptr &&
		            valueNeg->getType()->isIntegerTy(16));
		ASSERT_TRUE(valuePos != nullptr &&
		            valuePos->getType()->isIntegerTy(16));
		ASSERT_TRUE(valueMin != nullptr &&
		            valueMin->getType()->isIntegerTy(16));
		ASSERT_TRUE(valueMax != nullptr &&
		            valueMax->getType()->isIntegerTy(16));
	}
	...
	static void testNumberASTI32() {
		...
		ASSERT_TRUE(valueNeg != nullptr &&
		            valueNeg->getType()->isIntegerTy(32));
		ASSERT_TRUE(valuePos != nullptr &&
		            valuePos->getType()->isIntegerTy(32));
		ASSERT_TRUE(valueMin != nullptr &&
		            valueMin->getType()->isIntegerTy(32));
		ASSERT_TRUE(valueMax != nullptr &&
		            valueMax->getType()->isIntegerTy(32));
	}
};